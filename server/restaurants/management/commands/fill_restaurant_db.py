...
class Command(BaseCommand):
    ...
    def cuisine_list_conversion(self, cuisine: str) -> list[str]:
        """
        I am writing this particular doc string because my lazy future self will surely forgot why I did these many things down below
        
        1. The string have comma separated cuisine values.
        2. These values certainly not have integrity ["indian", "chinese","italian"] (as you can see extra space between comma)
    ...
    def handle(self, *args: Any, **options: Any) -> str | None:
            ...
            for line in fp:
                ...
                try:
                    ...
                    rest_query = Restaurant(
                        ...
                        cuisine=self.cuisine_list_conversion(restaurant_data.get("cuisine", "")),
        ...
        self.stdout.write(self.style.SUCCESS(f"Restaurant data created successfully\nConnection Q Len: {len(connection.queries)}"))